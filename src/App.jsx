		...
		<>
			{showVideo ? (
				...
				<main className="w-full">
					...
					<section
						id="hero"
						className=" p-2 py-6 flex flex-col h-screen relative items-center justify-center bg-cover bg-no-repeat bg-center"
						style={{ backgroundImage: "url('/images/bgcode.jpg')" }}>
						...
						<div className="relative z-20 max-w-152 md:max-w-202 gap-4 flex flex-col">
							<h4 className="text-4xl md:text-6xl font-extrabold ">
								Hi, i'm Henry <br /> Elueme Ositadimma
							</h4>
							...
							<div className="flex gap-4">
								<a href="/files/henry_cv.pdf" download>
									<Button className="mt-4 text-base font-semibold w-fit text-white bg-gray-950">
										Download Resume
									</Button>
								</a>

								<Button className="mt-4 text-base font-semibold w-fit text-white bg-purple-950">
									Let's chat!
								</Button>
							</div>
						</div>
					...
					<section
						id="about"
						className="text-white bg-gray-950 p-2 py-6 flex flex-col min-h-screen items-center justify-center">
						<div className="max-w-202 md:max-w-302  mx-auto w-full pb-10">
							<h4 className="text-md underline  font-bold my-8 text-zinc-500">
								about me
							</h4>
							<h4 className="text-3xl capitalize font-semibold text-center pb-4">
								A web developer passionate about <br />
							...
							<div className="flex flex-col md:flex-row gap-4">
								<div className="md:w-1/2 w-full">
									<img
										src="/images/hero.png"
										className="h-full w-full bg-cover bg-no-repeat animate-pulse"
									/>
								</div>
								<div className="md:w-1/2 w-full flex justify-center items-center flex-col gap-2">
									<p className="text-justify">
										I am a Full stack developer specializing in frontend
										development with a strong understnding of backend
										architecture, I build dynamic and scalable applications
										using Vite, Next.js and modern backend solutions like server
										actions, drizzle and databases utilizing MySQL and
										Relational Database to create seamless user experience and
										robust backend systems.{" "}
									</p>
									<p className="text-justify">
										My goal is to leverage my understanding of fullstack
										development to deliver impactful digital products, solve
										real-world problems, and grow into a technical leadership
										role where I can contribute to building scalable engineering
										teams and systems.
									</p>
								</div>
							</div>
					...
					<section
						id="skills"
						className="p-2 py-6 flex flex-col min-h-screen items-center justify-center">
						<div className="max-w-202 md:max-w-302  mx-auto w-full">
							<SectionHeading
								section="skills & technologies"
								heading="Software technical experties"
								subheading="Tools and technologies i frequently work with in actualizing ideas and bringing applications to life."
							/>
						</div>
						<div className="py-6 grid grid-cols-1 sm:grid-cols-2  gap-4 ">
							{tecSkills.map((data) => (
								<div
									className={`max-w-[400px] sm:w-[300px] gap-2 bg-black  p-3 flex flex-wrap`}>
									<h4 className="w-full flex gap-2 items-center text-md text-white">
										<span className="bg-purple-500 p-1 rounded-full text-white">
											{data.icon}
										</span>
										{data.title}
									</h4>
									{data.skills.map((skill) => (
										<span
											className="text-purple-400 font-semibold text-xs lg:text-sm  px-1 py-[1px]"
											key={skill}>
											{skill}
										</span>
									))}
					...
					<section
						...
						<div className="max-w-202 md:max-w-302  mx-auto w-full">
							<SectionHeading
								...
								heading="Software Projects built"
								subheading="Some of my recent projects showcasing my skill and experience, as well personal projects"
							/>

							<div className="w-full container  mx-auto flex flex-col items-center gap-2"></div>
					...
					<section
						...
						<div className="max-w-202 md:max-w-302  mx-auto w-full">
							<SectionHeading
								...
								heading="My Professional Software Journey"
								subheading="Some of the companies and clients i have ahd the pleasure of working and growing with."
							/>
					...
					<section
						...
						<div className="max-w-202 md:max-w-302  mx-auto w-full">
							<SectionHeading
								...
								heading="Share Your Ideas, Lets Make it Happen"
								subheading={`I will very much love to see your project become a real world application. Got an interesting project?  Let's discus how we can work together.`}
							/>
						</div>
							...
							<div>
								<ul>
									<li className="flex gap-4">
										<MdLocationOn className="w-5 h-6" /> Port Harcourt, Nigeria
									</li>

									<li className="flex gap-4">
										<IoMail className="w-5 h-6" /> chidielueme@gmail.com
									</li>
								</ul>
							</div>
								...
								<form className="w-full ">
									<div className="flex flex-col gap-2 my-4">
										...
										<input
											...
											className="hover:outline-0 outline-0 h-10 text-sm bg-purple-400/20 px-4 border-b border-zinc-400"
										/>
									</div>
									...
									<div className="flex flex-col gap-2 my-4">
										...
										<textarea
											...
											className="hover:outline-0 outline-0 h-full text-sm bg-purple-400/20 py-2 px-4 border-b border-zinc-400"
										/>
									</div>
									<Button className="mt-7 text-base font-semibold w-full text-white text-center bg-purple-950 justify-center">
										Send Message
									</Button>
								</form>
							</div>
